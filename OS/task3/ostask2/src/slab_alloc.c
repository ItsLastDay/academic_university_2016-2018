...
struct slab_allocator sl_struct_allocator = {sizeof(struct slab_allocator), NULL, NULL};

struct slab_allocator slab_buf_struct_allocator = {sizeof(struct slab_buf), NULL, NULL};
struct slab_allocator slab_struct_allocator = {sizeof(struct slab), NULL, NULL};
