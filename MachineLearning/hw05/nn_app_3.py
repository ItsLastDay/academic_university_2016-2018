...
def experiment_nn_3():
    ...
    num_steps = 80# 1500 // BATCH_SIZE + 1
    val_steps = 50# 190 // BATCH_SIZE + 1
    test_steps = 190 // BATCH_SIZE + 1
    ...
    sgd = optimizers.SGD(lr=1e-6, decay=0.01, momentum=0.9, nesterov=True)
    ...
    hist_callback = model.fit_generator(train, steps_per_epoch=num_steps,
            epochs=15, workers=3, validation_data=valid, 
            validation_steps=val_steps)
