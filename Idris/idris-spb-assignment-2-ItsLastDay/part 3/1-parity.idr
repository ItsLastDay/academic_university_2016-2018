...
binToNatParity : List Digit -> (n : Nat ** Parity n)
binToNatParity [] = (0 ** Even {n=0})
binToNatParity [I] = (1 ** Odd {n=0})
binToNatParity (I :: xs) with (binToNatParity xs)
  binToNatParity (I :: xs) | (x ** pf) = (_ ** (Odd {n=x}))
binToNatParity (O :: xs) with (binToNatParity xs)
  binToNatParity (O :: xs) | (x ** pf) = (_ ** (Even {n=x}))
